...
public class ExplicitWait {
    public static void main(String[] args) {
        ...
        //this below (visibilityOf) method some what consist than visibilityOfElementLocated
        explicitWait.until(ExpectedConditions.visibilityOf(driver.findElement(By.className("brand greenLogo"))));
        //use any one of the syntax one accceps Locator and the other Webelement itself
        
        explicitWait.until(ExpectedConditions.visibilityOfElementLocated(By.className("brand greenLogo")));
